...
namespace FillTheForm
{
	public class FillTheForm
	{
		...
		public void TestFormSubmission()
		{
			...
			var additionalInformationHeader = driver.FindElement(By.TagName("h3")).Text;
			Assert.That(additionalInformationHeader, Is.EqualTo("Additional Information"));
			...
			driver.Url = "file:///C:/path/to/the/file/SimpleForm/Thankyou.html";
